/**
 * Script para insertar datos reales directamente sin upsert
 */
...
async function insertarDatosDirectos() {
  console.log('🚀 Insertando datos reales directamente...');
  console.log('');
  ...
  try {
    ...
    // 2. Insertar grupos directamente
...
// Ejecutar el script
insertarDatosDirectos().catch(err => {
