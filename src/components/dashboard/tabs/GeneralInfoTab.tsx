...
import { AlertTriangle, Award, Users, TrendingUp, TrendingDown, Brain, CheckCircle } from 'lucide-react';
import AnalysisProgress from '../AnalysisProgress';
import RealTimeStats from '../RealTimeStats';

const GeneralInfoTab = ({ loading, reporteData, selectedGroup, getKpiData, estadisticas }) => {
  return (
